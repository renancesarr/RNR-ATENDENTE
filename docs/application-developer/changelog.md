...
- Login automático pós-healthcheck (shell), novos endpoints `/instance/*` e flags `--update`/`--no-keep-running` nos scripts de bootstrap — [1760573504-ia-code.md](1760573504-ia-code.md)
